...
export function TermsContent() {
    return (
        <div className="w-full max-w-3xl">
            <h2 className="text-heading2 font-bricolage text-[#E95D3C] text-center mb-4">
                Terms & Conditions
            </h2>

            {/* Scrollable Terms Content */}
            <div className="relative border border-[#D0CAC5] rounded-2xl min-h-[250px] md:min-h-[350px] max-h-[450px] overflow-hidden">
                <div className="overflow-y-auto h-full max-h-[450px] p-4 md:p-6 space-y-4 text-black font-bricolage">
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="text-sm md:text-base leading-relaxed space-y-1.5 pl-4">
                            <li>
                    ...
                    <div>
                        ...
                        <div className="text-sm md:text-base leading-relaxed space-y-2 pl-4">
                            <p>
