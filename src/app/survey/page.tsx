    ...
    <PageWrapper>
      ...
      <section className="px-4 md:px-8 lg:px-[120px]">
        <CenteredContent className="py-10">
          <h1 className="font-bricolage text-[28px] md:text-[40px] font-bold text-[#401A4D] leading-[1]">AI Research Agent</h1>
          <p className="font-bricolage text-[18px] md:text-[26px] text-[#401A4D] mt-2">Here&apos;s a quick preview of what will happen in your session</p>
        </CenteredContent>
      </section>
          ...
          <Button 
            ...
            icon={
              <svg width="24" height="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 8.5L22 12.5L18 16.5" stroke="#612A74" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M2 12.5H22" stroke="#612A74" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            }
          >
            Get a demo
