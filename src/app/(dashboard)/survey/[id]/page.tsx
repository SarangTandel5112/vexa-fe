...
export default function SurveyDemoPage({}: PageProps) {
    ...
    // Mock conversation state - no Eleven Labs integration
    ...
    const startConversation = async () => {
        try {
            setIsLoading(true);
            // Request microphone permission for voice activity detection
            await navigator.mediaDevices.getUserMedia({ audio: true });

            // Mock conversation start - no Eleven Labs integration
                                    ...
                                    <div
                                        ...
                                        style={{
                                            borderColor: `rgba(222, 115, 122, ${Math.max(
                                                0.3,
                                                0.3 +
                                                    (voiceIntensity / 100) * 0.4
                                            )})`,
                                            transform: `scale(${Math.max(
                                                0.95,
                                                0.95 +
                                                    (voiceIntensity / 100) * 0.1
                                            )})`,
