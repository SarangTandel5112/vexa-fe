...
export default function HomePage() {
    return (
        <div className="w-full min-h-[calc(100vh-80px)] bg-gradient-to-b from-[#fafaf9] to-[#fafaf9] bg-white flex justify-center py-[45px] px-5 md:py-[30px] md:px-4 pb-[60px] md:pb-10">
