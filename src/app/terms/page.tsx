                ...
                <div className="flex flex-col items-center gap-6 md:gap-8">
                    ...
                    <div className="text-center max-w-5xl">
                        ...
                        <p className="font-bricolage text-lg md:text-xl text-[#401A4D] leading-relaxed">
                            Please review and agree to the following before we
                            begin.
                        </p>
                    </div>
                            ...
                            <div className="overflow-y-auto h-full max-h-[500px] p-6 md:p-8 space-y-6 text-[#401A4D] font-bricolage">
                                <div>
                                    ...
                                    <p className="text-base md:text-lg leading-relaxed">
                                        This interview is a market research
                                        project conducted by Greybatter, a
                                        proprietorship (GSTIN:
                                        09APKPA7966A1ZV) under the brand
                                        name Vexa, on behalf of our
                                        client, BrandEigen LLP (GSTIN:
                                        06AAWFB7671G1ZY). The purpose is to
                                        gather insights into consumer
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg leading-relaxed">
                                        The data collected will be used solely
                                        for market research and analysis by
                                        BrandEigen and Greybatter. Final
                                        research findings will be aggregated and
                                        anonymised; your individual responses
                                        will not be personally identifiable in
                                        the final report.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg leading-relaxed">
                                        ...
                                        interview will be conducted by an AI
                                        (Artificial Intelligence) moderator. The
                                        AI is designed to have a natural
                                        conversation and guide the interview
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg leading-relaxed mb-3">
                                        By participating, you consent to the
                                        collection of the following data:
                                    </p>
                                    <ul className="text-base md:text-lg leading-relaxed space-y-2 pl-4">
                                        <li>
                                            • Audio Data: A recording of your
                                            spoken words.
                                        </li>
                                        <li>
                                            • Video Data: A recording of your
                                            on-camera participation during the
                                            interview.
                                        </li>
                                        <li>
                                            • Transcript Data: A text-based
                                            transcript of the conversation.
                                        </li>
                                        <li>
                                            • Survey Responses: Any data you
                                            provide by responding to the
                                            questions.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-base md:text-lg leading-relaxed space-y-3 pl-4">
                                        <p>
                                            ...
                                            Your audio data will be processed
                                            by ElevenLabs Inc., a third-party AI
                                            technology provider, to facilitate
                                            the live conversation.
                                        </p>
                                        <p>
                                            <strong>Data Transfers:</strong>{" "}
                                            Vexa&apos;s platform is hosted on
                                            Amazon Web Services (AWS), and data
                                            may be stored in a server location
                                            chosen for this project (e.g., UK or
                                            India). However, as the third-party
                                            processor, ElevenLabs Inc. is based
                                            in the United States, your data will
                                            be transferred and processed in the
                                            US. This is conducted under a
                                            legally compliant framework
                                            (UK&apos;s International Data
                                            Transfer Agreement - IDTA) that
                                            provides safeguards equivalent to UK
                                            data protection regulations.
                                        </p>
                                        <p>
                                            <strong>No Secondary Use:</strong>{" "}
                                            Your data will not be used by
                                            ElevenLabs Inc. to train its public
                                            AI models.
                                        </p>
                                        <p>
                                            <strong>Storage:</strong> All
                                            recordings and transcripts will be
                                            securely stored by Greybatter on
                                            behalf of BrandEigen and will be
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg leading-relaxed">
                                        ...
                                        erasure of your data. To exercise these
                                        rights, please contact Greybatter at{" "}
                                        <a
                                            href="mailto:arindam@brandeigen.com"
                                            className="underline hover:text-[#612A74] transition-colors"
                                        >
                                ...
                                <div>
                                    ...
                                    <p className="text-base md:text-lg leading-relaxed">
                                        ...
                                        read, understood, and agree to these
                                        Terms and Conditions. You explicitly
                                        consent to the collection, processing,
                                        and transfer of your data as described.
                                    </p>
                                </div>
                            </div>
