...
export function Header({ variant = 'landing', showNewTopic = false, showDemo = true, className = '' }: HeaderProps) {
  const renderButtons = () => {
    switch (variant) {
      case 'landing':
        return (
  ...
  return (
    <header className={`w-full px-4 py-9 border-b border-[#D0CAC5] ${className}`}>
